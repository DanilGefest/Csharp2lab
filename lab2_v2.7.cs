using System;
using static BasicFile.Program;

namespace BasicFile {
    internal class Program {
        public static void DocumentOutput(BasicDocument basicFile) // материнский класс
        {
        ...
        public class BasicDocument {
          ...
          static void Main(string[] args)
           {
            Singleton.Instance.Main1(); //ссылка на sigletone
    ...
    public class Singleton {
        ...
        public void Main1() 
        {
            ...
            Console.WriteLine("This is a basic info of documents");
